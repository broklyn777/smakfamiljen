  ...
  collections: {
    recipes: collection({
      ...
      schema: {
        ...
        ingredients: fields.array(fields.object({ name: fields.text({ label: "Ingrediens" }), amount: fields.number({ label: "Mängd" }), unit: fields.text({ label: "Enhet" }) }), { label: "Ingredienser", itemLabel: (props) => props.fields.name.value }),
